...
import com.roks.realpostgres.repository.Dog;
...
//Привет, если ты это читаешь, то ты нашел посхалку) Красава! Если хочешь, напиши мне об этом в телегу @uwuthless, мне будет приятно)